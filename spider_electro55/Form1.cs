...
namespace spider_electro55
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            result = MySqlLib.MySqlData.MySqlExecute.SqlScalar("SELECT electro55_datetime FROM resources.`electro55` ORDER BY electro55_datetime DESC LIMIT 0,1", conn_str);
            ...
            for (k = Convert.ToInt32(Math.Floor(time_interval.TotalMinutes / 30)); k >= 1; k--)
            {
                ...
                byte[] data111 = { 0x55, 0x06, 0x03, result_mem[2], result_mem[3], 0x0F };
                req = GetCRC(data111);
                ...
                result = MySqlLib.MySqlData.MySqlExecute.SqlNoneQuery("INSERT INTO resources.`electro55` (`electro55_datetime`,`electro55_active`,`electro55_reactive`) VALUES (" + "'" + date_prof + time_prof + "'" + "," + "'" + active_prof_str + "'" + "," + "'" + reactive_prof_str + "'" + ")", conn_str);
